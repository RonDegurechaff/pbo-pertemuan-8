    ...
    ?>
            <tr>
                ...
                <td>
                     ...
                     <!-- Tombol View -->
                    <button class="" onclick="window.location.href = '../Views/View_put_pembayaran.php?id_pembayaran=<?php echo base64_encode($Get['id_pembayaran']) ?>';">
                        <img src="../img/eye.png" style="width: 30px">
                        
                    </button>

                    <!-- Delete -->
                    <button class="" onclick="konfirmasi(<?php echo $Get['id_pembayaran'] ?>)">
