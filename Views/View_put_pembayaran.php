...
?>
    ...
    <form action="../Config/Routes.php?function=put_pembayaran" method="POST">
        ...
        <table border="1">
            ...
            <tr>
                <td>Nama Siswa</td>
                <td><input type="hidden" name="nisn" value="<?php echo $Get['nisn']; ?>" readonly required><input type="text" value="<?php echo $Get['nama']; ?>" readonly required></td>
            </tr>

            <tr>
                <td>Tanggal Bayar</td>
                <td><input type="text" name="tgl_bayar" value="<?php echo $Get['tgl_bayar']; ?>" onKeyPress="return isNumberKey(event);" required></td>
            </tr>

            <tr>
                <td>Bulan dibayar</td>
                <td><input type="text" name="bulan_dibayar" value="<?php echo $Get['bulan_dibayar']; ?>" onKeyPress="return ValidateAlpha(event);" required></td>
            </tr>

            <tr>
                <td>Tahun Bayar</td>
                <td><input type="text" name="tahun_bayar" value="<?php echo $Get['tahun_bayar']; ?>" onKeyPress="return isNumberKey(event);" required></td>
            </tr>
            ...
            <tr>
                <td>Jumlah Bayar</td>
                <td><input type="text" name="jumlah_bayar" value="<?php echo $Get['jumlah_bayar'] ?>" onKeyPress="return isNumberKey(event);" required></td>
            </tr>
