    ...
    ?>
            <tr>
                ...
                <td>
                     ...
                     <!-- Tombol View -->
                    <button class="" onclick="window.location.href = '../Views/View_put_petugas.php?id_petugas=<?php echo base64_encode($Get['id_petugas']) ?>';">
                        <img src="../img/eye.png" style="width: 30px">
                    </button>

                    <!-- Delete -->
                    <button class="" onclick="konfirmasi(<?php echo $Get['id_petugas'] ?>)">
                    ...
                    <a onclick="konfirmasi(<?php echo $Get['id_petugas'] ?>)">Delete</a>
                    -->
                </td>
            </tr>
    <?php
