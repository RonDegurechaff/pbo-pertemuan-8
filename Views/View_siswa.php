    ...
    ?>
            <tr>
                ...
                <td>
                     ...
                     <!-- Tombol View -->
                    <button class="" onclick="window.location.href = '../Views/View_put_siswa.php?nisn=<?php echo base64_encode($Get['nisn']) ?>';">
                        <img src="../img/eye.png" style="width: 30px">
                    </button>

                    <!-- Delete -->
                    <button class="" onclick="konfirmasi(<?php echo $Get['nisn'] ?>)">
