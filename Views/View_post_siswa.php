...
<form action="../Config/Routes.php?function=create_siswa" method="POST">
    <input type="hidden" name="csrf_token" value="<?php echo CreateCSRF(); ?>" name="myform" onsubmit="return validateform()">
    <table border="1">
        <tr>
            <td>NISN</td>
        ...
        <tr>
            <td>Nama</td>
            <td><input type="text" name="nama" onKeyPress="return ValidateAlpha(event);" required>
