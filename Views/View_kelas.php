    ...
    ?>
            <tr>
                ...
                <td>
                    ...
                    <!-- Tombol View -->
                    <button class="" onclick="window.location.href = '../Views/View_put_kelas.php?id_kelas=<?php echo base64_encode($Get['id_kelas']) ?>';">
                        <img src="../img/eye.png" style="width: 30px">
                        
                    </button>

                    <!-- Delete -->
                    <button class="" onclick="konfirmasi(<?php echo $Get['id_kelas'] ?>)">
